export const UNI_LIST = 'https://tokens.etherfair.org'
...
const ETHF_LIST = 'https://gateway.pinata.cloud/ipfs/QmdtYPXnT5CJXVuWuVpbHqh84bZJmTcQmkG43zya6WUdKY'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [ETHF_LIST]
