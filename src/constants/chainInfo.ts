...
const CHAIN_INFO: ChainInfoMap = {
  [SupportedChainId.MAINNET]: {
    ...
    infoLink: 'https://dexscreener.com/ethereumfair',
    label: 'EthereumFair',
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    infoLink: 'https://dexscreener.com/optimism',
    label: 'Optimism',
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://dexscreener.com/arbitrum',
    label: 'Arbitrum',
  ...
  [SupportedChainId.POLYGON]: {
    ...
    infoLink: 'https://dexscreener.com/polygon',
    label: 'Polygon',
  ...
  [SupportedChainId.CELO]: {
    ...
    infoLink: 'https://dexscreener.com/celo',
    label: 'Celo',
    logoUrl: celoLogo,
